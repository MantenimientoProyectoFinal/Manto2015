...
<!--
  function EliminarPais(strPaisName){
    return confirm("¿Desea eliminar el epais '" + strPaisName + "'?")
  }
-->
</script>
    <br>
    ...
    <div class="table" style="width:100%" >
        ...
        <div class="tr" style="background:#CCCCCC;">
         <div class="td" style="width:20%"><b><fmt:message key="formaListadoPaises.etiqueta.descripcion" /></b></div>
        ...
        <c:forEach var="pais" items="${formaListadoPaises.pais}">
            <div class="tr">
